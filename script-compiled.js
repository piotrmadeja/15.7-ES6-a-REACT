    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          "nav",
          { className: "buttons" },
          React.createElement("a", { href: "#", className: "button-start", onClick: this.start.bind(this) }),
          React.createElement("a", { href: "#", className: "button-stop", onClick: this.stop.bind(this) }),
          React.createElement("a", { href: "#", className: "button-reset", onClick: this.reset.bind(this) })
        ),
        React.createElement(
          "div",
          { className: "screen" },
